...
if (isset($_POST["add"])) {
  ...
  if (empty($idAuthor) || empty($txtAuthor)) {
    $error_message = "Yêu cầu nhập Mã tác giả hoặc Tên tác giả";
  } else {
      $sql = "INSERT INTO tacgia (ma_tgia, ten_tgia, hinh_tgia) VALUES ('$idAuthor','$txtAuthor', '$picAuthor')";
            ...
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="picAuthor" >
                    </div>
