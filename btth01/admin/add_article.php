<?php
   ...
   if (isset($_POST['add'])) {
     ...
     $sql = "INSERT INTO baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, noidung, ma_tgia, ngayviet, hinhanh)
             VALUES ('$txtID', '$txtTitle', '$txtSongName', '$categoryID', '$summary', '$txtContent', '$authorID', '$date', '$txtPic')";
            ...
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control"name = "txtContent" name="txtContent" >
                    </div>
                    <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtPic" >
                    </div>
