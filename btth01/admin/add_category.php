    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if (!empty($category_name)){
            ...
            if ($temp -> execute()){
                ...
                $redirectUrl_success = "category.php";
                ...
                $redirectUrl_error_execute = "category.php";
            ...
            $redirectUrl_missing_required = "category.php";
