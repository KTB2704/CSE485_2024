...
if (isset($_POST["add"])) {
  ...
  if (empty($idCat) || empty($txtCatName)) {
    $error_message = "Yêu cầu nhập Mã thể loại hoặc Tên thể loại";
  } else {
      $sql = "INSERT INTO theloai (ma_tloai, ten_tloai) VALUES ('$idCat','$txtCatName')";
